...
(function () {
    ...
    function ensureModal() {
      ...
      overlay.innerHTML = `
        <div id="${MODAL_ID}" role="dialog" aria-modal="true" aria-label="Listing summary">
          <div class="osta-ee-gear-modal-header">
            <div class="osta-ee-gear-modal-title">Listing summary</div>
    ...
    function addGearButtons() {
      ...
      titles.forEach((h1) => {
        ...
        btn.setAttribute('aria-label', 'Listing summary');
        btn.title = 'Listing summary';

        // Gear icon opens the listing summary modal.
        btn.innerHTML = `
